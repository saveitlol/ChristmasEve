...
function function2() {
    var audioElemplay2 = document.getElementById('audio');
    var audioElemplay1 = document.getElementById('audio1');
    if (audioElemplay2.paused){
      audioElemplay2.play();
      audioElemplay1.pause();}
  else{
     audioElemplay2.pause();
     audioElemplay1.play();
}
}
// theme-button ends
// audio class
// function function4(){
//     var audioElemplay4 = document.getElementById('audio4');
//     if(audioElemplay4.click){
//     function2();
//     function3();
//     }
...
// } 
function fucntion3(){
    var audioElemplay3 = document.getElementById('video1')
    if (audioElemplay3.paused){
        audioElemplay2.pause();
        audioElemplay1.pause();}
}
